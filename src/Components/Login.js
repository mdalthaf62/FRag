...
<section class="flex flex-col md:flex-row h-screen items-center">
  ...
  <div class="bg-indigo-600 hidden lg:block w-full md:w-1/2 xl:w-2/3 h-screen">
    <img src="https://th.bing.com/th/id/OIP._Ydmh8YQHxihMmkeLHBVzwAAAA?rs=1&pid=ImgDetMain" alt="" class="w-full h-full object-cover" />
  </div>
    ...
    <div class="w-full h-100">
      ...
      <form class="mt-6" >
        ...
        <button type="submit" class="w-full block bg-indigo-500 hover:bg-indigo-400 focus:bg-indigo-400 text-white font-semibold rounded-lg
              px-4 py-3 mt-6"> <Link to={'/products'}>
              Log In</Link></button>
      </form>
      ...
      <p class="mt-8">Don't Have an Account? <NavLink to="/registration" class="text-blue-500 hover:text-blue-700 font-semibold">Create One! </NavLink></p>
